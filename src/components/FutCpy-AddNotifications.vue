  ...
  <div class="add-notification">
    ...
    <form @submit.prevent="submitNotification">
      <div class="form-group">
        ...
        <input
          ...
          v-model="heading"
          placeholder="e.g., Class 9 Mid Sem Exam TimeTable"
          maxlength="100"
          required
      ...
      <div class="form-group">
        ...
        ></textarea>
        <p class="char-counter">{{ content.length }}/500</p>
      </div>
      <div class="form-group">
    ...
    <ul v-else-if="notifications.length" class="notifications-list">
      <li v-for="notif in notifications" :key="notif.id">
        <span class="heading" @click="openNotificationPopup(notif)">{{ notif.heading }}</span>
        <button
          v-if="notif.image"
          class="attachment"
          @click="openImagePopup(notif.image)"
